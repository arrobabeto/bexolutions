<script setup lang="ts">
  ...
  import HomeMobile from "~/components/bexo/mobile/HomeMobile.vue"
    ...
    <template #desktop>
      <div ref="canvasRef" class="canvas" :style="{ height: canvasH + 'px' }">
        ...
        >
          ...
          >
            Bexolutions entwickelt das komplette Marketingsystem für Ihr KMU —
            von der Website über Local SEO bis zur KI-Sichtbarkeit. Heute bei
            Google gefunden. Morgen in ChatGPT, Perplexity und Google AI Mode
        ...
        >
          Inhabergeführtes Büro im Kanton Aargau. Ausgangslage: Website
          vorhanden, keine Rankings, 0 qualifizierte Anfragen über Google.
        </p>
        ...
        >
          ...
          >
            ...
            <p
              ...
              style="width: 740px"
            >
              Wir haben uns auf die digitale Sichtbarkeit von Treuhandbüros in
              der Deutschschweiz spezialisiert — mit bewährter Methode und
        ...
        >
          ...
          >
            ...
            <br />
            Wir zeigen Ihnen, wo Sie heute stehen und welche konkreten
