...
test.describe("Homepage smoke", () => {
  ...
  test("serves robots, sitemaps, and llms routes", async ({
    ...
    expect(llmsBody).toContain("# Bexolutions")
    expect(llmsBody).toContain("## Seiten")
    expect(llmsBody).toContain("## Wissen")
    expect(llmsBody).toContain("/wissen/")
    ...
    expect(llmsFullBody).toContain("# Bexolutions")
    expect(llmsFullBody).toContain("(Full)")
    expect(llmsFullBody).toContain("TL;DR:")
  })
})
